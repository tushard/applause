...
public class TesterDeviceResource {
	@Context
	...
	@GET
	public DataResponse<TesterDevice> getAll(@Context UriInfo uriInfo) {
		return Ag.select(TesterDevice.class, config).uri(uriInfo).get();
	}
